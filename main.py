...
client = pymongo.MongoClient('mongodb+srv://admin-tushar:pswd6920@cluster0.lngsx.mongodb.net/?retryWrites=true')
db = client['MessManagement']
peoplecount = db['peoplecounts']
    ...
    while True:
        ...
        for id, box in centroid_dict.items():
            if id in red_zone_list:
                ...
                text = "ID: {}".format(id)
                cv2.putText(frame, text, (box[2], box[3]-5), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255), 1)
            else:
        ...
        peoplecount.update_one({"_id": 1}, {"$set": {"lpc": lpc_count, "opc": opc_count}})
